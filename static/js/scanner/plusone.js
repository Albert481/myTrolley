...
(function () {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var p = window, t = document, ea = p.location, fa = function () {
    ...
    var Ea = function (a, b, c, d) {
        if (p[c + "EventListener"]) p[c + "EventListener"](a, b, !1); else if (p[d + "tachEvent"]) p[d + "tachEvent"]("on" + a, b)
    }, Fa = function () {
        var a = t.readyState;
        ...
        if (Fa()) a(); else {
            ...
            p.addEventListener ? (p.addEventListener("load", c, !1), p.addEventListener("DOMContentLoaded", c, !1)) : p.attachEvent &&
    ...
    var K = decodeURI("%73cript"), kb = /^[-+_0-9\/A-Za-z]+={0,2}$/, lb = function (a, b) {
        ...
        for (var c = t.getElementsByTagName(K), d = 0, e = c.length; d < e; ++d) {
            ...
            if (f.src && (a = String(f.nonce || f.getAttribute("nonce") || "") || null)) {
                ...
                if (g !== h &&
                    a && a === String(a) && a.match(kb)) return F.nonce = a
            }
        }
        return null
    }, ob = function (a) {
        if ("loading" != t.readyState) nb(a); else {
            var b = mb(), c = "";
            null !== b && (c = ' nonce="' + b + '"');
    ...
    var M = function (a) {
        ...
        if (b && "object" === typeof b) for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !tb(a[d]) && !tb(b[d]) ? O(a[d], b[d]) : b[d] && "object" ===
        typeof b[d] ? (a[d] = tb(b[d]) ? [] : {}, O(a[d], b[d])) : a[d] = b[d])
    }, ub = function (a) {
        if (a && !/^\s+$/.test(a)) {
        ...
        N(!0);
        var b = window.___gcfg, c = M("cu"), d = window.___gu;
        ...
        (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = ub(f)) && b.push(f));
        a && vb(c, a);
        d = M("cd");
        a = 0;
    ...
    var Eb = window.console, Fb = function (a) {
        Eb && Eb.log && Eb.log(a)
    };
    var Gb = function () {
        return !!F.oa
    ...
    var Lb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        Mb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//, Nb = function (a) {
            ...
            null == b && (a = a || window.location.href, b = C(a, "authuser") ||
                null, null == b && (b = (b = a.match(Lb)) ? b[1] : null));
    ...
    var Pb, R, S = void 0, T = function (a) {
            try {
        ...
        }, Qb = U(0), Rb = U(new Date(0)), Sb = U(!0), Tb = U(""), Ub = U({}), Vb = U([]), V = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a,
                        "toJSON") || (e !== Vb || a.constructor !== Array && a.constructor !== Object) && (e !== Ub || a.constructor !== Array && a.constructor !== Object) && e !== Tb && e !== Qb && e !== Sb && e !== Rb)) return V(a.toJSON.call(a), c);
                if (null == a) b[b.length] = "null"; else if (e === Qb) a = Number(a), isNaN(a) || isNaN(a - a) ? a = "null" : -0 === a && 0 > 1 / a && (a = "-0"), b[b.length] = String(a); else if (e === Sb) b[b.length] = String(!!Number(a)); else {
                    if (e === Rb) return V(a.toISOString.call(a), c);
                    if (e === Vb && U(a.length) === Qb) {
                        b[b.length] = "[";
                        var f = 0;
                        for (d = Number(a.length) >> 0; f < d; ++f) f &&
                        (b[b.length] = ","), b[b.length] = V(a[f], c) || "null";
                        b[b.length] = "]"
                        ...
                        for (f in a) Object.prototype.hasOwnProperty.call(a,
                            f) && (e = V(a[f], c), void 0 !== e && (d++ && (b[b.length] = ","), b[b.length] = V(f), b[b.length] = ":", b[b.length] = e));
                        b[b.length] = "}"
                    } else return
                }
                return b.join("")
            }
        }, Wb = /[\0-\x07\x0b\x0e-\x1f]/, Xb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
        Yb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
        Zb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
        $b = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g,
        ac = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g, bc = /[ \t\n\r]+/g,
        cc = /[^"]:/, dc = /""/g, ec = /true|false|null/g, fc = /00/, gc = /[\{]([^0\}]|0[^:])/,
        hc = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/, ic = /[^\[,:][\[\{]/, jc = /^(\{|\}|\[|\]|,|:|0)+/, kc = /\u2028/g,
        lc = /\u2029/g, mc = function (a) {
            a = String(a);
    ...
    W.prototype.update = function (a, b) {
        if (null != a) {
            ...
            for (var c = b - this.j, d = 0, e = this.F, f = this.o; d < b;) {
                if (0 == f) for (; d <= c;) tc(this, a, d), d += this.j;
    ...
    var vc = p.crypto, wc = !1, xc = 0, yc = 0, zc = 1, Ac = 0, Bc = "", Cc = function (a) {
        a = a || p.event;
    ...
    var Kc = {
        ...
        vspace: "0",
        width: "100%"
    }, Lc = {allowtransparency: !0, onload: !0}, Mc = 0, Nc = function (a) {
        A(!a || Da.test(a), "Illegal url for new iframe - " + a)
    }, Oc = function (a, b, c, d, e) {
        Nc(c.src);
        var f, g = Hc(d, c), h = g ? Ic(d) : "";
        try {
    ...
    var Pc = /^:[\w]+$/, Qc = /:([a-zA-Z_]+):/g, Rc = function () {
        var a = Nb() || "0", b = Ob();
        var c = Nb(void 0) || a;
        var d = Ob(void 0), e = "";
        ...
        var f = P("iframes/:socialhost:"), g = P("iframes/:im_socialhost:");
        return Kb = {
            socialhost: f,
    ...
    var Wc = {se: "0"}, Xc = {post: !0},
        ...
        $c = v(F, "WI", w()), ad = function (a, b, c) {
            ...
            f.exp = P(g + "exp");
            if (g = P(g + "location")) for (d = 0; d < g.length; d++) {
                var h = g[d];
                f[h] = p.location[h]
            }
            switch (a) {
            ...
            c._methods = q.join(",");
            return za(e, f, c)
        }, bd = ["style", "data-gapiscan"], dd = function (a) {
            ...
            Ib(function (b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = ad(d, b, 0);
                        g ? (f = f.parentNode,
                        e.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, ed(f, b), (d = Q[f.lastChild.id]) && (d.oid = c), Jb(c, 4))) : delete Q[c]
                    } else delete Q[c]
                }
            })
        };
    ...
    var nd = function (a, b) {
        ...
        if (od(jd || {})) for (var y in c) {
            ...
            d = [];
            for (y in c) for (a = c[y], u = 0, b = a.length; u < b; u++) e = a[u], qd(y, e, dd(e), d, b);
            rd(r, d)
        }
    }, sd = function (a) {
        var b = v(B, a, {});
    ...
    var pd = function (a, b) {
            ...
            case 1:
                if (b.parentNode) {
                    ...
                    if (k.forcePost || n && 2E3 < f.length) {
                        ...
                        for (e = 0; e < h.length; e++) l =
                            b.createElement("input"), l.type = "hidden", l.name = h[e][0], l.value = h[e][1], k.appendChild(l);
                        c.appendChild(k);
                        k.submit();
        ...
        if (a && 1 === a.nodeType && b) {
            if (c) return 1;
            if (X[b]) {
                if (Ka[a.nodeName.toLowerCase()]) return (a = a.innerHTML) && a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,
                    "") ? 0 : 1
            } else {
                if (hd[b]) return 0;
                if (gd[b]) return 1
    ...
    var Ad = /^\{h:'/, Bd = /^!_/, Cd = "", xd = function (a, b) {
        ...
        if (d.s && a && -1 != ia.call(b, a)) {
            if ("_renderstart" === d.s || d.s === Cd + "/" + a + "::_renderstart") if (d = d.a && d.a[c ? 0 : 1], b = t.getElementById(a), Jb(a, 2), d && b && d.width && d.height) {
                a:{
                    c = b.parentNode;
                    a = d || {};
                    if (Gb()) {
    ...
    var Rd = function () {
        ...
        L("auth", {
            callback: function () {
                var a = p.gapi.auth, e = {client_id: c, session_state: b};
                a.checkSessionState(e, function (b) {
                    var c = e.session_state, d = P("isLoggedIn");
                    ...
                    xb("savedUserState", c);
                    (d || f) && Db(b) && !P("disableRealtimeCallback") && a._pimf(b,
                        !0)
                })
            }
        });
...
gapi.load("plusone", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.A3bPl19Ptok.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCM-1b0_G-ZaXK7b1vtDXTjO7gYpAQ",
